...
<?php
  ...
  $meetings = $meetings_orm->where('student_id')->is($_SESSION['user']['id'])
    ->where('scheduled_on')->greaterThan(date("Y-m-d H:i:s"))
    ->join('users', function($join){
        $join->on('meetings.advisor_id', 'users.id');
    })
    ->all();
...
<main class="container my-5 mx-0 px-0">
    <div class="container px-4 py-5" id="hanging-icons">
        ...
        <a href="<?php echo_base_url();?>/views/student/meeting.php?mode=create" class="btn btn-primary">
            Create New Meeeting
        </a>
        ...
        <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
            ...
            <div class="col d-flex align-items-start">
                <div>
                    ...
                    <p>Advisor: <?php echo $meeting->email; ?></p>
                    <p>Scheduled On: <?php echo $meeting->scheduled_on; ?></p>

                    <a href="<?php echo_base_url();?>/views/student/meeting.php?cancel&meeting_id=<?php echo $meeting->id;?>" class="btn btn-danger">
                        Cancel Meeeting
                    </a>
                </div>
            </div>
        ...
        <div class="col d-flex align-items-start">
          ...
          if(count($events) > 0){
            ...
            <div class="col-4">
                ...
                <p><?php echo $event->scheduled_on ??  "-"; ?></p>
                <p>Organized By: <?php echo $event->email; ?></p>
            </div>
